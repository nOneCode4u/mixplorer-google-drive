...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| 📁 **MiXplorer**    | Fast, smooth, dual-pane file manager with cloud storage, archive support, built-in media player, and deep customisation. No ads, no trackers.                                                     | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiXplorer)     |
| 🗜️ **MiX Archive** | Archive add-on — full create/extract support for ZIP, RAR, RAR5, 7z, TAR, GZ, BZ2, XZ, ISO and more. Supports password-protected and multi-volume archives. Requires MiXplorer.                   | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+Archive)   |
| 🎵 **MiX Codecs**   | Media codec add-on — extends MiXplorer's built-in player with additional audio/video decoding for FLAC, OGG, MKV, AVI and formats not natively supported by Android. Requires MiXplorer.          | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+Codecs)    |
| 🔐 **MiX Encrypt**  | Encryption add-on — AES-based file encryption and decryption directly inside MiXplorer. Manage encrypted containers without leaving the file manager. Requires MiXplorer.                         | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+Encrypt)   |
| 🖼️ **MiX Image**   | Image viewer add-on — wide format support including RAW, TIFF, and WEBP, with smooth zoom, pan, and gallery navigation. Includes basic editing and rotation. Requires MiXplorer.                  | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+Image)     |
| 📄 **MiX PDF**      | PDF viewer add-on — render and navigate PDF documents of any length directly inside MiXplorer. Supports text selection, zoom, and multi-page navigation. Requires MiXplorer.                      | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+PDF)       |
| 🏷️ **MiX Tagger**  | Audio tag editor add-on — view and edit ID3v1, ID3v2, Vorbis Comment, APEv2 and other tag formats for MP3, FLAC, OGG, M4A, OPUS and more. Supports batch editing and artwork. Requires MiXplorer. | [View →](https://github.com/nOneCode4u/mixplorer-google-drive/releases?q=MiX+Tagger)    |
